...
<aside id="sidebar" class="admin-sidebar text-white h-100 flex-column d-none d-md-flex">
    ...
    <nav class="flex-grow-1 overflow-auto py-3 px-3 scrollbar-hidden">
        ...
        <!-- Community Section -->
        @canany(['users.view', 'roles.view', 'social.view'])
        <div class="mb-4">
            ...
            @endcan
            @can('roles.view')
            <a href="{{ route('admin.roles.index') }}" class="nav-link {{ request()->routeIs('admin.roles*') ? 'active' : 'text-white-50' }} d-flex align-items-center gap-3 px-3 py-2 rounded-3 small">
        ...
        <!-- Content Section -->
        @canany(['posts.view', 'comments.view', 'engagement.view', 'media.view', 'memories.view'])
        <div class="mb-3">
        ...
        <!-- Communication -->
        @canany(['messaging.view', 'notifications.view'])
        <div class="mb-4">
        ...
        <!-- Monetization -->
        @canany(['contests.view', 'earnings.view'])
        <div class="mb-4">
