...
<head>
    ...
    <title>Confirm Sign-in - {{ config('app.name', 'StyleBite') }}</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .notice {
            border: 1px solid rgba(36, 25, 34, 0.12);
            color: var(--muted);
            background: rgba(36, 25, 34, 0.04);
        }
    ...
    <main class="login-shell">
        <div class="brand">
            ...
            <div>
                ...
                <p>We sent a 6-digit code to {{ $maskedEmail }}. It expires in 10 minutes.</p>
            </div>
        </div>
        ...
        <div class="actions">
            <form method="POST" action="{{ route('admin.login.otp.resend') }}">
                @csrf
                <button class="link-button" type="submit">Send a new code</button>
            </form>

            <a class="back-link" href="{{ route('admin.login') }}">Use a different account</a>
        </div>
    </main>
</body>
</html>
