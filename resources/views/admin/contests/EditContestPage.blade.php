...
<div class="contests-page space-y-5">
    ...
    <div class="mb-4 d-flex align-items-start justify-content-between flex-wrap gap-3">
        <div>
            <h1 class="display-6 fw-extrabold mb-1" style="letter-spacing: -0.04em;">Edit Contest</h1>
            <p class="text-muted small mb-0">Update the contest details and rules.</p>
        </div>
    ...
    <div class="glass rounded-4 p-4 border-white-05">
        @include('admin.contests.partials.form', [
            'contest' => $contest,
            'action' => route('admin.contests.update', $contest),
            'method' => 'PATCH',
            'formTitle' => 'Edit Contest',
